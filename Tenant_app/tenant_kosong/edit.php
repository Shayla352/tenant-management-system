...
<div class="form-group">
    ...
    <input type="number" name="luas" value="<?= $row['luas'] ?>" required>
</div>
...
<div class="form-group">
    ...
    <input type="number" name="harga_3th" value="<?= $row['harga_3th'] ?>" required>
</div>
<div class="form-group">
    <label>Service Charge 3 Tahun</label>
    <input type="number" name="service_3th" value="<?= $row['service_3th'] ?>" required>
</div>
<div class="form-group">
    <label>DP 20% (3 Tahun)</label>
    <input type="number" name="dp_3th" value="<?= $row['dp_3th'] ?>" required>
</div>
<div class="form-group">
    <label>Pelunasan 80% (3 Tahun)</label>
    <input type="number" name="pelunasan_3th" value="<?= $row['pelunasan_3th'] ?>" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="number" name="harga_5th" value="<?= $row['harga_5th'] ?>" required>
</div>
<div class="form-group">
    <label>Service Charge 5 Tahun</label>
    <input type="number" name="service_5th" value="<?= $row['service_5th'] ?>" required>
</div>
<div class="form-group">
    <label>DP 20% (5 Tahun)</label>
    <input type="number" name="dp_5th" value="<?= $row['dp_5th'] ?>" required>
</div>
<div class="form-group">
    <label>Pelunasan 80% (5 Tahun)</label>
    <input type="number" name="pelunasan_5th" value="<?= $row['pelunasan_5th'] ?>" required>
</div>
<div class="form-group">
